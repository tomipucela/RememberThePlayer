...
# Leer archivo Excel
datos <- read_excel("C:/Users/tomip/OneDrive/Documentos/pucelale/pucelale.local/laliga/atleticomadrid/atleticomadrid.xlsx", sheet = 1)
...
output_file <- "C:/Users/tomip/OneDrive/Documentos/pucelale/pucelale.local/laliga/atleticomadrid/atleticomadrid.js"
